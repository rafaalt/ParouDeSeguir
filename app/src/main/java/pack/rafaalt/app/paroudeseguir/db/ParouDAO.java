...
public class ParouDAO {

        private ParouDB parouDB;
        public ParouDAO(ParouDB parouDB){
            this.parouDB = parouDB;
        }
        ...
        public void criarTabela(String id){
            ...
            SQLiteDatabase writeDb = this.parouDB.getWritableDatabase();
        ...
        public ArrayList<Conta> getSeguidores(String idUser){
            ...
            SQLiteDatabase readDB = this.parouDB.getReadableDatabase();
    ...
    public void deleteTable(String idUser){
        SQLiteDatabase deleteDB = this.parouDB.getWritableDatabase();
